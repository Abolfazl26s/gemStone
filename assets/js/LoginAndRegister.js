  ...
  return swal
    .fire({
      ...
      html: `
        ...
        <div id="Login-Frm" class="d-flex align-items-center justify-content-center flex-wrap gap-3">
          <form id="frm-login" class="w-100" action="">
        ...
        <div class="text-start">         
          <a href="#" id="btn-forgotPassword" class="me-auto text-muted">فراموشی رمز عبور</a>
        </div>
        
      `,
      footer: `<a href="#" style="font-size:15px;"" id="btn-register" class="text-dark">در صورتی که قبلا ثبت نام نکرده اید <strong class="text-danger">اینجا ( عضویت )</strong> کلیک کنید.</a>`,
...
function Register() {
  ...
  swal
    .fire({
      ...
      `,
      footer: `<a href="#" style="font-size:15px;" class="btn-login text-dark" id='btn-login'>در صورتی که قبلا ثبت نام کرده اید <strong class="text-danger">اینجا (ورود)</strong> کلیک کنید.</a>`,
      showCloseButton: true,
      showConfirmButton: true,
      showCancelButton: true,
